<x-layouts.main :title="$title" :mainPage="$main_page" :page="$page">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                @if (count($pengurus) < 1) <tr>
                                    ...
                                    <x-modal modalTitle="Update Donatur" modalID="updatePengurus" btn="Update" action=""
                                        method="POST" method2="PUT" enctype="">
                                        <div class="row mb-3">
                                            <div class="input-box col-sm-12">
                                                <label for="nama2" class=" mb-2 required">Nama</label>
                                                <input type="text" id="nama2" class="form-control" name="nama"
    ...
    <x-modal modalTitle="Tambah Donatur" modalID="addPengurus" btn="Tambah" action="{{ url('pengurus') }}" method="POST"
